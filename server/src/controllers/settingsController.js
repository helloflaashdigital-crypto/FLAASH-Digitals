...
export async function getSettings(req,res){let settings=await SiteSettings.findOne().lean();if(!settings)settings={companyName:'FLAASH Digital',tagline:'Digital Solutions | Creative Impact'};res.json({success:true,data:settings})}
